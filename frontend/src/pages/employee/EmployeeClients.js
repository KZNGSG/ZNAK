    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 mt-1">База клиентов компании</p>
        </div>
        <Link
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <button
          ...
          className="px-4 py-2.5 bg-slate-700/50 hover:bg-slate-700 text-slate-200 text-sm font-medium rounded-xl transition-colors"
        >
          Искать
        </button>
      </div>
      ...
      {clients.length > 0 ? (
        ...
        <div className="bg-slate-900/50 border border-slate-800/50 rounded-xl p-12 text-center">
          ...
          <h3 className="text-lg font-medium text-slate-300 mb-2">Нет клиентов</h3>
