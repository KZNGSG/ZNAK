/**
 * ⚠️ ВНИМАНИЕ: ЭТО РЕЗЕРВНАЯ/УСТАРЕВШАЯ ПАНЕЛЬ!
 * 
 * Основная работа ведётся в /employee (EmployeeLayout.js)
 * 
 * Структура панелей:
 * - /employee - Основная CRM панель (сотрудники, суперадмины)
 * - /admin    - Резервная панель (НЕ ИСПОЛЬЗОВАТЬ)
 * - /partner  - Портал партнёров
 * - /cabinet  - Личный кабинет клиентов
 * 
 * Новый функционал добавлять в /employee, НЕ СЮДА!
 */
...
const AdminLayout = ({ children }) => {
  ...
  const menuItems = [
    ...
    { path: '/admin/education', icon: 'M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14zm-4 6v-7.5l4-2.222', label: 'Обучение' },
  ];
